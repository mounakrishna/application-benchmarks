...
#error "Please define a way to initialize a memory block."
	...
	// Enabling Performance parameters
	#if (HPM_ENABLE)
	write_csr(mhpmevent3,30);
	write_csr(mhpmevent4,29);
	write_csr(mhpmevent5,27);
	write_csr(mhpmevent6,26);
	write_csr(mhpmevent7,25);
	write_csr(mhpmevent8,24);
	write_csr(mhpmevent9,23);
	write_csr(mhpmevent10,22);
	write_csr(mhpmevent11,21);
	write_csr(mhpmevent12,20);
	write_csr(mhpmevent13,19);
	write_csr(mhpmevent14,18);
	write_csr(mhpmevent15,17);
	write_csr(mhpmevent16,16);
	write_csr(mhpmevent17,15);
	write_csr(mhpmevent18,14);
	write_csr(mhpmevent19,13);
	write_csr(mhpmevent20,12);
	write_csr(mhpmevent21,11);
	write_csr(mhpmevent22,10);
	write_csr(mhpmevent23,9);
	write_csr(mhpmevent24,8);
	write_csr(mhpmevent25,7);
	write_csr(mhpmevent26,6);
	write_csr(mhpmevent27,5);
	write_csr(mhpmevent28,4);
	write_csr(mhpmevent29,3);
	write_csr(mhpmevent30,2);
	write_csr(mhpmevent31,1);
	...
	printf("dcache_read_hits= %d \n",read_csr(mhpmcounter22));
	printf("dcache_write_hits= %d \n",read_csr(mhpmcounter23));
	printf("dcache_atomic_hits= %d \n",read_csr(mhpmcounter24));
